...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aideepseekservice
```

A live public deployment of this template is available at [https://aideepseekservice.templates.workers.dev](https://aideepseekservice.templates.workers.dev)
